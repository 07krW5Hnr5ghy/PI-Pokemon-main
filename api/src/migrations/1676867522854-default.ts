...
export class default1676867522854 implements MigrationInterface {
    name = 'default1676867522854'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."pokemon_origin_enum" AS ENUM('api', 'custom')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TYPE "public"."pokemon_origin_enum"`);
    }
